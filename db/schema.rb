...
ActiveRecord::Schema.define(version: 2020_03_12_033630) do
  ...
  create_table "spree_inventory_controls", force: :cascade do |t|
  ...
  create_table "spree_verified_inventory_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["variant_id"], name: "index_spree_verified_inventory_items_on_variant_id"
    t.index ["variant_sku", "inventory_control_id"], name: "verified_inventory_items_variant_inventory_index", unique: true
    t.index ["variant_sku"], name: "index_spree_verified_inventory_items_on_variant_sku"
  end
